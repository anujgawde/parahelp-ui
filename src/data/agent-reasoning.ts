...
export const ticketResolutions: Record<string, TicketResolution> = {
  ...
  default: {
    ...
    resolutionPlan: [
      ...
      {
        id: "step-2",
        label: "Retrieve subscription email",
        icon: "stripe",
        status: "complete",
      },
      {
        id: "step-3",
        label: "Retrieve last invoice",
        icon: "stripe",
        status: "complete",
      },
      {
      ...
      {
        id: "step-6",
        label: "Change subscription email",
        icon: "stripe",
        status: "complete",
      },
      {
  ...
  "TK-4199": {
    ...
    resolutionPlan: [
      ...
      {
        id: "step-2",
        label: "Verify cancellation date",
        icon: "stripe",
        status: "complete",
      },
      {
        id: "step-3",
        label: "Retrieve payment details",
        icon: "stripe",
        status: "complete",
      },
      {
        id: "step-4",
        label: "Calculate refund amount",
        icon: "link",
        status: "complete",
      },
      {
        id: "step-5",
        label: "Process refund ($42.00)",
        icon: "stripe",
        status: "complete",
      },
      {
  ...
  "TK-4201": {
    ...
    resolutionPlan: [
      ...
      {
        id: "step-2",
        label: "Retrieve billing cycle",
        icon: "stripe",
        status: "complete",
      },
      {
        id: "step-3",
        label: "Retrieve upgrade options",
        icon: "stripe",
        status: "complete",
      },
      {
  ...
  "TK-4197": {
    ...
    resolutionPlan: [
      ...
      {
        id: "step-2",
        label: "Check email delivery logs",
        icon: "link",
        status: "complete",
      },
      {
  ...
  "TK-4195": {
    ...
    resolutionPlan: [
      ...
      {
        id: "step-3",
        label: "Retrieve current subscription",
        icon: "stripe",
        status: "complete",
      },
      {
